...
class Item
{
    ...
    /**
     * @var Collection<int, LesonModule>
     */
    #[ORM\OneToMany(targetEntity: LesonModule::class, mappedBy: 'leson')]
    ...
    /**
     * @return Collection<int, LesonModule>
     */
    ...
    public function addModule(LesonModule $module): static
    {
        if (!$this->module->contains($module)) {
            $this->module->add($module);
            $module->setLeson($this);
        }

        return $this;
    }

    public function removeModule(LesonModule $module): static
    {
        if ($this->module->removeElement($module)) {
            // set the owning side to null (unless already changed)
            if ($module->getLeson() === $this) {
                $module->setLeson(null);
            }
        }
